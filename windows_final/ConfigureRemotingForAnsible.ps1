...
Function Enable-GlobalHttpFirewallAccess
{
    ...
    $rule.RemotePorts = "*"
    $rule.LocalAddresses = "10.100.0.0/24"
    $rule.RemoteAddresses = "10.100.0.0/24"
    $rule.Enabled = $true
    $rule.Direction = 1
    $rule.Action = 1
...
If ($fwtest1.count -lt 5)
{
    ...
    netsh advfirewall firewall add rule profile=private name="Allow WinRM HTTPS for 10.100.0.0/24" dir=in localport=5986 protocol=TCP action=allow localip=10.100.0.0/24 remoteip=10.100.0.0/24
